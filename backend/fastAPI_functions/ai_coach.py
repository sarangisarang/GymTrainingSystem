...
async def ai_coach(
    ...
    # RAG (#32): only retrieve knowledge for the model path — with no training
    # data we short-circuit to a fallback and never call the model.
    knowledge = _knowledge_block(body.message) if tag_map else ""
